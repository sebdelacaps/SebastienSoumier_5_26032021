...
document.addEventListener("DOMContentLoaded", confirmation = () => {
  ...
  orderId_confirmation.innerHTML =
    "L'identifiant de votre commande est : " + orderId_result;

  total_confirmation.innerHTML =
    "Merci de votre commande, d'un montant de " + totalOrder_result + "€";
